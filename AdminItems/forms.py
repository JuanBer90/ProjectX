...
class UploadFileForm(forms.Form):
    nombre = forms.CharField(widget=TextInput(attrs={'class': 'form-control','id':'id_nombre_item','name':'nombre_archivo'}),max_length=50)
...
class DocumentForm(forms.Form):
    ...
    nombre = forms.CharField(widget=TextInput(attrs={'class': 'form-control','id':'id_nombre_item'}),max_length=50)
