...
urlpatterns = patterns('',
    ...
    url(r'^mensaje_bienvenida/$', TemplateView.as_view(template_name='mensaje_password.html')),
    url(r'^admin$', include(admin.admin.site.urls)),
    url(r'^reestablecer/(?P<id_user>\d+)/$', 'AdminUsuarios.views.reestablecer_pass'),
    url(r'^recuperar/', 'AdminUsuarios.views.recuperar'),
