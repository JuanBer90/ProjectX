...
var Dajaxice = {
    ...
    search_fases: function(callback_function, argv, custom_settings){
        return Dajaxice.call('search_fases', callback_function, argv, custom_settings);
    },
    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('sayhello', callback_function, argv, custom_settings);
    },
